         ...
         <div class="d-flex justify-content-center align-items-center">
            ...
            <div  class="d-flex justify-content-center align-items-center" >
                <form action="loguearse.php" method="POST">
                    ...
                    <input type="submit" class="btn btn-primary" id="loguearse" name="loguearse" value="loguearse"/>
                  </form>
        ...
        <div class="section2" id="section2">
             ...
             <div  class="d-flex justify-content-center align-items-center" >
                ...
                <form action="Registrarse.php" method="POST">
                    ...
                    <input type="submit" class="btn btn-primary" value="regsitrarse" name="regsitrarse" >
                  </form>
