  ...
  <div class="contenedor">
    ...
    <div class="parte-izquierda">
      ...
      <div class="menus">
        ...
        <a href="Empleado.php" style="display: flex;gap:1px;">
      ...
      <div class="menuTabla contenedor2">
        <table class="table table-custom table-striped">
          ...
          <tbody class="" id="tabla">
            ...
            "</td>
            <td>
            <a type='button' class='btn btn-warning'  name='Editar' href='EditarEmpleado.php?id=".
            $val["EmpleadoId"].
          "&req=edit'>Editar</a>
            </td>
            <td>
            <a type='button' class='btn btn-danger'  name='Eliminar' href='BorrarEmpleado.php?id=".
            $val["EmpleadoId"].
